        ...
        <div className="p-6">
          {activeTab === "profile" && (
            <div className="max-w-md space-y-4">
              ...
              <div>
                ...
                <Input defaultValue="john@quickfixplumbingbristol.co.uk" disabled className="bg-gray-50" />
              </div>
              <div>
          ...
          {activeTab === "notifications" && (
            <div className="max-w-md space-y-6">
              {[
                { label: "New Lead Alerts", desc: "Get notified when a new lead comes in", checked: true },
                { label: "Status Change Alerts", desc: "Get notified when a lead status changes", checked: true },
                { label: "Assignment Alerts", desc: "Get notified when a lead is assigned to you", checked: false },
                { label: "Daily Summary", desc: "Receive a daily summary of activity", checked: false },
              ].map((item) => (
          ...
          {activeTab === "company" && (
            <div className="max-w-md space-y-4">
              ...
              <div>
                ...
                <Input defaultValue="info@quickfixplumbingbristol.co.uk" />
              </div>
              <div>
